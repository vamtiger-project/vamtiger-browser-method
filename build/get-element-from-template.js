...
var noElementName = types_1.ErrorMessage.noElementName, noTemplate = types_1.ErrorMessage.noTemplate, noElementForSelector = types_1.ErrorMessage.noElementForSelector;
function default_1(params) {
    return __awaiter(this, void 0, void 0, function () {
        var name, template, loadStylesheets, selector, container, element, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    name = params.name, template = params.template, loadStylesheets = params.loadStylesheets, selector = params.selector;
                    container = name && template && document.createElement(types_1.TagName.template);
                    element = null;
                    if (!name) {
...
//# sourceMappingURL=get-element-from-template.js.map