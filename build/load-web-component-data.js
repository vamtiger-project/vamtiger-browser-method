...
function getWebComponentData(_a) {
    var url = _a.url;
    return __awaiter(this, void 0, void 0, function () {
        var head_1, selector, jsonLdSelector, jsonSelector, existingScript, script, _b, scripts, _c, _d, jsonLdScripts, jsonScript, jsonLd_1, json, webComponentData, error_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 4:
                    ...
                    jsonLd_1 = jsonLdScripts && jsonLdScripts.map(function (jsonLdScript) { return parse(jsonLdScript); });
