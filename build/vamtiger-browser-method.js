...
var dispatch_event_1 = require("./dispatch-event");
var setup_service_worker_1 = require("./setup-service-worker");
...
var vamtigerBrowserMethod = {
    ...
    loadMethod: function (params) { return __awaiter(_this, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = Boolean;
                return [4 /*yield*/, load_method_1.default(params)];
    ...
    getJsonLdArray: get_json_ld_array_1.default,
    method: {}
};
main().catch(handleError);
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var VamtigerBrowserMethod_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    VamtigerBrowserMethod_1 = self.VamtigerBrowserMethod;
                    if (!!VamtigerBrowserMethod_1) return [3 /*break*/, 3];
                    self.VamtigerBrowserMethod = vamtigerBrowserMethod;
                    setup_service_worker_1.default();
                ...
                case 2:
                    _a.sent();
                    dispatch_event_1.default({ eventName: types_1.EventName.vamtigerBrowserMethodReady });
                    _a.label = 3;
