...
var sendMessageFromWorker = getPostMessage();
...
var intersectionObserverThreshold = getIntersectionObserverThreshold(5);
...
function getServiceWorkerClients (params) {
    return __awaiter(this, void 0, void 0, function () {
        var clients, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getClients(params)];
                case 1:
                    _a = (_b.sent());
                    _b.label = 2;
                case 2:
...
function getClients(_a) {
    var type = _a.type;
    var config = __assign({}, serviceWorkerClients, { type: type });
    var clients = self && self.clients && self.clients.matchAll && self.clients.matchAll(config);
    return clients;
}

function sendMessageFromServiceWorker (_a) {
    var _b = _a.clients, type = _b === void 0 ? 'window' : _b, message = _a.message;
    return __awaiter(this, void 0, void 0, function () {
        var clients;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, getServiceWorkerClients({ type: type })];
                case 1:
                    clients = _c.sent();
                    Promise.all(clients.map(function (client) { return client.postMessage(message); }));
                    return [2 /*return*/];
            }
        });
    });
...
function sendMessage (params) {
    ...
    var _a = params.workerType, workerType = _a === void 0 ? WorkerType.worker : _a;
    ...
    if (isWindow()) {
        ...
        sendMessageFromServiceWorker({ message: message });
    }
}
...
function getEnvironment () {
    var environment = isWorker() && Environment.worker
...
function getMessageData$1(_a) {
    ...
    if (typeof messageData.params === 'string') {
        messageData.params = __assign({}, parse$4(messageData.params), { ports: ports });
    }
    return messageData;
}
...
var cacheName = CacheName.vamtigerBrowserMethod;
function getCache () {
    return __awaiter(this, void 0, void 0, function () {
        var caches, cache, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = caches;
                    if (!_a) return [3 /*break*/, 2];
                    return [4 /*yield*/, caches.open(cacheName).catch(handleError$3)];
                case 1:
                    _a = (_b.sent());
                    _b.label = 2;
                case 2:
...
var requestIdleCallback$2 = self.requestIdleCallback;
var nothing$5 = StringConstant.nothing, slash$1 = StringConstant.slash;
var blobParams = {
    type: ScriptType.js
};
function loadMethod (params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    if (isWindow()) {
                        if (requestIdleCallback$2) {
                            requestIdleCallback$2(function () { return loadMethodWindow(__assign({}, params, { resolve: resolve, reject: reject })); });
                        }
                        else {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    get = _.get;
                    return [4 /*yield*/, loadScript({ src: src }).catch(function (error) { return scriptLoadError = error; })];
                case 1:
                    script = _b.sent();
...
function getMessageId () {
    var prefix = isWindow() && Prefix.messageIdWindow
...
function getMethodResult (params) {
    return new Promise(function (resolve, reject) {
        if (isWindow()) {
            if (requestIdleCallback$3) {
                requestIdleCallback$3(function () { return getMethodResultWindow(__assign({}, params, { resolve: resolve, reject: reject })); });
            }
            else {
...
function getMethodResultWindow(_a) {
    var _b = _a.messageId, messageId = _b === void 0 ? getMessageId() : _b, name = _a.name, params = _a.params, resolve = _a.resolve, reject = _a.reject;
    return __awaiter(this, void 0, void 0, function () {
...
var requestIdleCallback$4 = self.requestIdleCallback;
function updateMethod (params) {
    if (isWindow()) {
        if (requestIdleCallback$4) {
            requestIdleCallback$4(function () { return updateMethodWindow(params); });
        }
        else {
            setTimeout(function () { return updateMethodWindow(params); }, 0);
        }
    }
}
function updateMethodWindow(_a) {
    var name = _a.name;
    return __awaiter(this, void 0, void 0, function () {
        var VamtigerBrowserMethod, method, nameMethod;
        return __generator(this, function (_b) {
            VamtigerBrowserMethod = self.VamtigerBrowserMethod;
            method = VamtigerBrowserMethod.method;
            nameMethod = method[name];
            if (nameMethod) {
                method[name] = function (params) { return getMethodResult({ name: name, params: params }); };
            }
            return [2 /*return*/];
        });
    });
...
var requestIdleCallback$5 = self.requestIdleCallback;
function importDependencies (params) {
    if (isWindow() && requestIdleCallback$5) {
        if (requestIdleCallback$5) {
            requestIdleCallback$5(importDependenciesWindow);
        }
        else {
...
function importDependenciesWindow() {
    ...
    var dependencyUrlMetaElement = metaElement.querySelector(Selector.dependencyUrlMetaElement);
    var urlMetaElements = dependencyUrlMetaElement && Array.from(dependencyUrlMetaElement.querySelectorAll(Selector.urlMetaElement)) || [];
...
function importDependenciesWorker(_a) {
    ...
    var action = MessageAction.removeDependencyUrl;
    importScripts && urls.forEach(function (url) {
        importScripts(url);
        sendMessage({ action: action, params: { url: url } });
    });
}

var requestIdleCallback$6 = self.requestIdleCallback;
function removeDependencyUrl (params) {
    if (isWindow()) {
        if (requestIdleCallback$6) {
            requestIdleCallback$6(function () { return removeDependencyUrlWindow(params); });
        }
        else {
...
function removeDependencyUrlWindow(_a) {
    ...
    var metaElement = self["vamtiger-browser-method"];
    var dependencyUrlMetaElement = metaElement.querySelector(Selector.dependencyUrlMetaElement);
    var selector$$1 = "meta[data-url=\"" + url + "\"]";
    var urlMetaElement = dependencyUrlMetaElement && dependencyUrlMetaElement.querySelector(selector$$1);
...
function getWorkerUrl () {
    ...
    var workderScript = head.querySelector(Selector.vamtigerBrowserMethod);
    var workerDependecies = (Array.from(head.querySelectorAll(Selector.workderDependency)) || [])
        .map(function (_a) {
        var innerHTML = _a.innerHTML;
        return innerHTML;
    })
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (currentWorker) {
                        currentWorker.addEventListener('message', handeMessage);
                        currentWorker.addEventListener('error', handleError$4);
                    }
...
function handleError$4(event) {
    var keys = Object.keys(event);
    keys.forEach(function (key) { return console.error(typeof event[key] === 'string' || stringify$2(event[key])); });
}

var IntersectionObserver = self.IntersectionObserver, requestIdleCallback$7 = self.requestIdleCallback;
...
function handleIntersect(entries, observer) {
    entries.forEach(function (entry) {
        if (requestIdleCallback$7) {
            requestIdleCallback$7(function () { return handleIntersectElement(entry); });
        }
        else {
...
function handleIntersectElement(entry) {
    ...
    if (isIntersecting) {
        ...
        dataset[DataAttribute.visible] = nothing$6;
    }
}

var slash$2 = StringConstant.slash;
var trailingHtml = regex.trailingHtml;
function getPageRelativeUrl () {
    var relativePath = location.pathname;
    var urlPaths = relativePath.match(trailingHtml) && relativePath.split(slash$2);
    var pageUrl = urlPaths && urlPaths.slice(0, urlPaths.length - 1).join(slash$2)
        || relativePath;
    return pageUrl;
}

var slash$3 = StringConstant.slash, nothing$7 = StringConstant.nothing;
var vamtigerBrowserMethod = LocalHostRelativePath.vamtigerBrowserMethod;
function getServiceWorkerRegistration () {
    return __awaiter(this, void 0, void 0, function () {
        var sharedWorkerRegistration, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = isWindow();
                    if (!_a) return [3 /*break*/, 2];
                    return [4 /*yield*/, getServiceWorker()];
                case 1:
                    _a = (_b.sent());
                    _b.label = 2;
                case 2:
                    sharedWorkerRegistration = _a || undefined;
...
function getServiceWorker() {
    return __awaiter(this, void 0, void 0, function () {
        var serviceWorker$$1, origin, url, pageUrl, secondaryUrl, secondaryConfig, sharedWorkerRegistration, _a, secondarySharedWorkerRegistration, _b, registration;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    serviceWorker$$1 = navigator.serviceWorker;
                    origin = location.origin;
                    url = [
                        origin,
                        vamtigerBrowserMethod
                    ].join(slash$3);
                    pageUrl = getPageRelativeUrl();
                    secondaryUrl = [
                        pageUrl === slash$3 ? '' : pageUrl,
                        vamtigerBrowserMethod
                    ].join(nothing$7);
                    secondaryConfig = __assign({}, serviceWorker, { scope: pageUrl });
                    _a = serviceWorker$$1;
                    if (!_a) return [3 /*break*/, 2];
                    return [4 /*yield*/, serviceWorker$$1
                            .register(url, serviceWorker)
                            .catch(handleError$5)];
                case 1:
                    _a = (_c.sent());
                    _c.label = 2;
                case 2:
                    ...
                    _b = !sharedWorkerRegistration && secondaryUrl !== url && serviceWorker$$1;
                    if (!_b) return [3 /*break*/, 4];
                    return [4 /*yield*/, serviceWorker$$1
...
var nothing$8 = StringConstant.nothing;
var metaElementHtml = [
...
function setEventListeser() {
    var serviceWorker = navigator.serviceWorker;
    serviceWorker && serviceWorker.addEventListener('message', handeMessage);
}
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    textMode = isTextMode();
                    return [4 /*yield*/, getServiceWorkerRegistration()];
                case 1:
                    serviceWorkerRegistration = _c.sent();
                    messageChannel = new MessageChannel();
                    port1 = messageChannel.port1;
                    customeElementMetaElement.dataset[DataAttribute.customElementName] = nothing$8;
                ...
                case 2:
                    ...
                    port1.addEventListener('message', handeMessage);
                    return [2 /*return*/];
            }
        });
    });
...
var nothing$9 = StringConstant.nothing;
if (document$1) {
...
var nothing$10 = StringConstant.nothing, slash$4 = StringConstant.slash;
function getMicrodataCaption (_a) {
    ...
    fieldData.forEach(function (currentFieldData) {
        if (currentFieldData) {
            ...
            if (currentCaption) {
                currentCaption.setAttribute('itemscope', nothing$10);
...
var requestIdleCallback$8 = self.requestIdleCallback;
var nothing$11 = StringConstant.nothing, slash$5 = StringConstant.slash;
var leadingAt = regex.leadingAt, remoteUrl$1 = regex.remoteUrl, email = regex.email;
function getJsonLdArray (params) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (requestIdleCallback$8) {
                requestIdleCallback$8(function () { return getJsonLdArray$1(params).then(resolve).catch(reject); });
            }
            else {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    nestedEntries = _b;
                    entry = [[startCase(key.replace(leadingAt, nothing$11)), entryValue && (key.match(email) && getEmailLink({ href: entryValue.toString(), text: entryValue.toString() }) || getEntryValue(entryValue)) || nothing$11]];
...
function getEntryValue(value) {
    ...
    var linkText = linkHref && valueString && valueString.split(slash$5).pop();
...
function loadDependencies () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!isWindow()) return [3 /*break*/, 2];
                    return [4 /*yield*/, loadDependenciesWindow()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                    if (!(isWorker() || isServiceWorker)) return [3 /*break*/, 4];
...
function getFetchResponse (_a) {
    var request = _a.request;
    return __awaiter(this, void 0, void 0, function () {
        var cache, response, cacheResponse;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getCache()];
                case 1:
                    cache = _b.sent();
                ...
                case 2:
                    ...
                    cacheResponse = response
                        ...
                        && response.clone();
                    if (!(cache && cacheResponse)) return [3 /*break*/, 4];
                    return [4 /*yield*/, cache.put(request, cacheResponse).catch(handleError$6)];
                case 3:
                    _b.sent();
                    _b.label = 4;
...
function updateRequestCache (_a) {
    var request = _a.request;
    return __awaiter(this, void 0, void 0, function () {
        var cache, response, updateCache;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getCache()];
                case 1:
                    cache = _b.sent();
                    return [4 /*yield*/, fetch(request).catch(handleError$7)];
                case 2:
                    response = _b.sent();
                    updateCache = response
                        && (response.status === 200 || response.type === 'opaque');
                    if (!(cache && updateCache && response)) return [3 /*break*/, 4];
                    return [4 /*yield*/, cache.put(request, response).catch(handleError$7)];
                case 3:
                    _b.sent();
                    _b.label = 4;
                case 4: return [2 /*return*/];
...
function handleError$7(error) {
    console.warn(error.message);
}

function getCachedFetchResponse (_a) {
    var request = _a.request;
    return __awaiter(this, void 0, void 0, function () {
        var cache, response, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, getCache()];
                case 1:
                ...
                case 3:
                    response = _b;
                    if (response) {
                        updateRequestCache({ request: request });
                    }
...
function handleFetchRequest (event) {
    return __awaiter(this, void 0, void 0, function () {
        var cachedResponse, response, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getCachedFetchResponse(event)];
                case 1:
                    cachedResponse = _b.sent();
                    _a = cachedResponse;
                    if (_a) return [3 /*break*/, 3];
                    return [4 /*yield*/, getFetchResponse(event)];
                case 2:
                    _a = (_b.sent());
                    _b.label = 3;
                case 3:
...
function handleServiceWorkerActivation (event) {
    isServiceWorker() && handleServiceWorkerActivation$1(event);
}
function handleServiceWorkerActivation$1(event) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            params = indexedDbIsAccessible && support && __assign({ environment: environment }, support) || {};
            message = {
                action: MessageAction.saveSupport,
                params: params
            };
            sendMessage(message);
            importScripts && workerDependencies.forEach(function (dependency) { return importScripts(dependency); });
            return [2 /*return*/];
        });
    });
}
...
function setupServiceWorker () {
    isServiceWorker() && setupServiceWorker$1();
}
function setupServiceWorker$1() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            addEventListener('install', handleServiceWorkerActivation);
            addEventListener('activate', handleServiceWorkerActivation);
            addEventListener('message', handeMessage);
            addEventListener('fetch', function (event) { return handleFetchRequest(event); });
            return [2 /*return*/];
        });
    });
}
...
var vamtigerBrowserMethod$1 = {
    loadScript: loadScript,
    loadScripts: loadScripts,
    loadScriptsSequentially: loadScriptsSequentially,
    loadMethod: function (params) { return __awaiter(_this$1, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = Boolean;
                return [4 /*yield*/, loadMethod(params)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    VamtigerBrowserMethod = self.VamtigerBrowserMethod;
                    if (!!VamtigerBrowserMethod) return [3 /*break*/, 3];
                    self.VamtigerBrowserMethod = vamtigerBrowserMethod$1;
                    setupServiceWorker();
