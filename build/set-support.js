        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    support = {
                        environment: is_window_1.default() && types_1.Environment.window
                            || is_worker_1.default() && types_1.Environment.worker
                    ...
                    if (is_window_1.default()) {
                        save_support_1.default(support);
                    }
                    else {
                        sendWorkerSupport();
                    }
...
function setWorkerSupport(currentSupport) {
    return __awaiter(this, void 0, void 0, function () {
        var VamtigerBrowserMethod, environment;
        return __generator(this, function (_a) {
            VamtigerBrowserMethod = self.VamtigerBrowserMethod;
            environment = currentSupport.environment;
            if (environment === types_1.Environment.worker) {
                VamtigerBrowserMethod.workerSupport = currentSupport;
            }
            else if (environment === types_1.Environment.serviceWorker) {
                VamtigerBrowserMethod.serviceWorkerSupport = currentSupport;
            }
            save_support_1.default(currentSupport);
            return [2 /*return*/];
        });
    });
}
