        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    styles = Array
                        .from(container.content.querySelectorAll(types_1.Selector.style))
                        .map(function (style, index) { return ({
                        name: [
                            name,
                            types_1.ScriptNameSuffix.style,
                            index++
                        ].join(dash),
                        css: style.innerHTML
                    }); });
                    stylesheets = Array
                        .from(container.content.querySelectorAll(types_1.Selector.stylesheet))
                        .map(function (stylesheet, index) { return ({
                        name: [
                            name,
                            types_1.ScriptNameSuffix.stylesheet,
                            index++
                        ].join(dash),
                        href: stylesheet.href
                    }); });
                    return [4 /*yield*/, Promise.all(styles.map(load_script_1.default).concat(stylesheets.map(load_script_1.default)))];
                case 1:
...
//# sourceMappingURL=load-container-stylesheets.js.map