...
function default_1(_a) {
    var storeName = _a.storeName, keyPath = _a.keyPath, data = _a.data, messageId = _a.messageId;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    save.addEventListener('success', function () { return handleSuccess({ messageId: messageId, key: keyPath }); });
                    return [2 /*return*/];
            }
        });
    });
...
function handleSuccess(_a) {
    var messageId = _a.messageId, key = _a.key;
