...
function saveSupportDataWindow(support) {
    var VamtigerBrowserMethod = self.VamtigerBrowserMethod;
    var environment = VamtigerBrowserMethod.environment, workerSupport = VamtigerBrowserMethod.workerSupport;
