...
exports.default = (function (params) { return new Promise(function (resolve, reject) {
    var scripts = new Set();
    ...
    params.forEach(function (scriptParams) {
        load = load
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all(scriptParams.map(load_script_1.default))];
...
//# sourceMappingURL=load-scripts-sequentially.js.map