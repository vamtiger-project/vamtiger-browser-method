...
export declare const vamtigerBrowserMethod: {
    ...
    loadScriptsSequentially: <P extends (LocalScriptParams | LocalStylesheetScriptParams | ILoadRemoteScriptParams | ILoadRemoteStylesheetScriptParams)[][]>(params: P) => Promise<LoadedScriptsSequentially<P>>;
