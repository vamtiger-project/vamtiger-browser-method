...
function setupServiceWorker() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            addEventListener('fetch', function (event) { return handle_fetch_request_1.isValidProtocol(event) && event.respondWith(handle_fetch_request_1.default(event)); });
            return [2 /*return*/];
        });
    });
}
//# sourceMappingURL=setup-service-worker.js.map