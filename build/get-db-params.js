...
var dbName = types_1.DbName.vamtigerBrowserSupport;
...
function handleUpgradeNeeded(_a) {
    var db = _a.db;
    var storeNames = Object.keys(types_1.DbKeyPath);
    storeNames.forEach(function (storeName) { return !db.objectStoreNames.contains(storeName) && db.createObjectStore(types_1.DbStoreName[storeName], {
        keyPath: types_1.DbKeyPath[storeName]
    }); });
}
//# sourceMappingURL=get-db-params.js.map